...
connectionString = process.env.DATABASE_URL || 'postgres://memewars:guest@localhost:5432/memewars';
const connection = new ORM(connectionString);
...
app.get('/hydrate', (req, res, next)=> {
  res.status(404).end('cet hydrate not found');
}, (req, res)=> {
